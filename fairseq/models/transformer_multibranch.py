...
@register_model("transformer_multibranch")
class TransformerMultibranchModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        # args for Multibranch attention
...
class TransformerMbEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args, index):
        return TransformerMbEncoderLayer(args, index)
...
class TransformerMbDecoder(FairseqIncrementalDecoder):
    ...
    def build_decoder_layer(self, args, index, no_encoder_attn=False):
        return TransformerMbDecoderLayer(args, index, no_encoder_attn)
...
@register_model_architecture("transformer_multibranch", "transformer_multibranch")
...
@register_model_architecture("transformer_multibranch", "transformer_multibranch_iwslt_de_en")
...
@register_model_architecture("transformer_multibranch", "transformer_multibranch_wmt_en_de")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("transformer_multibranch", "transformer_multibranch_vaswani_wmt_en_de_big")
...
@register_model_architecture("transformer_multibranch", "transformer_multibranch_vaswani_wmt_en_fr_big")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("transformer_multibranch", "transformer_multibranch_wmt_en_de_big")
...
@register_model_architecture("transformer_multibranch", "transformer_multibranch_wmt_en_de_big_t2t")
